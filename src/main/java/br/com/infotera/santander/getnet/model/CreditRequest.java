...
public class CreditRequest {
    ...
    public CreditRequest(boolean delayed, boolean authenticated, boolean pre_authorization, boolean save_card_data, String transaction_type, int number_installments, String soft_descriptor, Integer dynamic_mcc, Card card) {
